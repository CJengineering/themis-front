...
export const travels: Travel[] = [
  {
    id: 1,
    status: 'Pending',
    requestedDepartureDate: new Date('2023-06-15'),
    requestedDepartureCity: 'New York',
    requestedArrivalCity: 'Paris',
    requestedArrivalDate: new Date('2023-07-05'),
  ...
  },
  {
    id: 2,
    status: 'Confirmed',
    requestedDepartureDate: new Date('2023-02-10'),
    requestedDepartureCity: 'Los Angeles',
    requestedArrivalCity: 'New York',
    requestedArrivalDate: new Date('2023-02-10'),
    name: 'Business Trip',
    userId: 456,
    tripType: 'One-Way',
  ...
  },
  {
    id: 3,
    status: 'Pending',
    requestedDepartureDate: new Date('2023-04-22'),
    requestedDepartureCity: 'Chicago',
    requestedArrivalCity: 'Las Vegas',
    requestedArrivalDate: new Date('2023-04-22'),
